...
## Data collection
The Stereolabs ZED 2i stereo camera together with their software ZED SDK 4.0 was used to collect the data used in this project. The pebble setup (figure 1) was used as study object to collect in total 25 images. 

<center>
<figure>
<a href=><img src= width="90%" height="90%" ></a><figcaption> Figure 1: Example of the pebble setup. </figcaption>
</figure>
</center>
## Model construction
